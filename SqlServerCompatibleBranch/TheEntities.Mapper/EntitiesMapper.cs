...
namespace TheEntities.Mapper
{
    public class QuestionMap : ClassMap<Question>
    {
        public QuestionMap()
        {
            ...
            Not.LazyLoad();
            Id(x => x.QuestionId); // for Postgres: .GeneratedBy.Sequence("question_seq");
    ...
    public class QuestionCommentMap : ClassMap<QuestionComment>
    {
        public QuestionCommentMap()
        {
            ...
            Id(x => x.QuestionCommentId); // for Postgres: .GeneratedBy.Sequence("question_comment_seq");
    ...
    public class AnswerMap : ClassMap<Answer>
    {
        public AnswerMap()
        {
            ...
            Id(x => x.AnswerId); // for Postgres: .GeneratedBy.Sequence("answer_seq");
    ...
    public class AnswerCommentMap : ClassMap<AnswerComment>
    {
        public AnswerCommentMap()
        {
            ...
            Id(x => x.AnswerCommentId); // for Postgres: .GeneratedBy.Sequence("answer_comment_seq");
